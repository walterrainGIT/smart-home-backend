...
export class Migration20250104092954 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`create table "market"."orders" ("id" serial, "created_at" timestamptz null, "updated_at" timestamptz null, "user_id" int not null, 
      "status" varchar(255) not null, "lot_id" serial not null, constraint "orders_pkey" primary key ("id"));`);
